  ...
  <div className="min-h-screen bg-[#fffaf5] p-8 pb-64">
      ...
      {cartItems.length === 0 ? (
          ...
          <div className="fixed left-0 right-0 flex justify-center pointer-events-none" style={{ bottom: bottomOffset }}>
            <div className="w-full max-w-4xl mx-auto bg-white shadow-lg rounded-2xl p-4 md:p-6 flex justify-between items-center pointer-events-auto">
              ...
              <button
                ...
                className="bg-gradient-to-r from-[#054616] to-[#054a0f]  hover:to-[#0c8222] text-white px-6 md:px-8 py-2.5 rounded-full font-medium shadow-md hover:shadow-lg transition-all"
              >
                Checkout
              </button>
            </div>
       ...
       <div className=" max-w-4xl mx-auto py-16 px-4">
          <Link to="/shop" className="px-2 py-3 bg-green-900 text-white rounded-2xl font-semibold shadow-md hover:bg-green-800 transition">
           ← Back to Shop
         </Link>
         </div>
    </div>
