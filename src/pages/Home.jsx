          ...
          <div className="col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <motion.div
                ...
                className="absolute text-[#3e2f24] inset-0 flex flex-col items-center justify-center text-center text-br font-semibold text-lg md:text-xl leading-relaxed tracking-wide space-y-2 drop-shadow-[0_6px_12px_rgba(0,0,0,0.55)] px-4"
              >
