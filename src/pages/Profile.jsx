...
const members = [
  {
    ...
    avatar: "public/profiles/p1.png",
  },
  {
    name: "SivLinh",
    email: "sivlinh@gmail.com",
    avatar: "public/profiles/p4.png",
  },
  {
    name: "Nova",
    email: "nova@gmail.com",
    avatar: "public/profiles/p3.png",
  },
];
...
<button
              type="submit"
              className="w-full bg-blue-300 text-white py-2 rounded-md font-semibold hover:bg-gray-800 transition"
            >
              LOGIN
            </button>
          </form>
